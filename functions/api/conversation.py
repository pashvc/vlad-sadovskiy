...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        logger.info("Received request for conversation")
        ...
        try:
            logger.info("Making request to Tavus API")
            ...
            logger.info("Received response from Tavus API")
            ...
            logger.info(f"Sending response: {json.dumps(response_data)[:200]}...")
